...
<body>
    <main>
        <div style="margin:0 auto; width:80rem;">
            <form action="">
                <div>
                    <div class="first"> 
                        <h1 style="margin:8rem 0;
                        text-align: center;"><img src="resources/common/imgs/logo_01.png" alt="원스톱캠퍼스"></h1>
                        <p style="text-align:center; margin-bottom:6rem;
                        font-size:3rem;">회원가입을 축하드립니다!</p>
                        <p style="text-align:center; margin-bottom:8rem;
                        font-size:1.8rem;"><span style="color:#1428A0;">테스트</span> 님의 신규 가입을 진심으로 축하드립니다.</p>
                    </div>
                    <div class="second" style=" margin-bottom:5rem;">
                        <p style="font-size:1.5rem; margin-bottom:1rem;"><span style="color:#1428A0;">테스트</span> 님이 OneStopCampus 에 가입하신 등록 정보입니다.</p>
                        ...
                        border-bottom:1px solid #ccc;">
                            <p>
                                ...
                                line-height: 4rem;
                                background:#f2f2f2;
                                text-align: center;">아이디</label>
                                <input type="text" readonly style="padding-left:1rem;
                                width:48rem;
                                font-size:1.5rem;
                                text-align: center;
                                color:#1428A0;
                        ...
                        font-size:1.3rem;">※회원정보 변경이 필요하신 경우 회원정보수정에서 수정이 가능합니다.</p>
                    </div>
    ...
    background:#1428A0;
    border:0 none;
    cursor: pointer;">원스톱캠퍼스 바로가기</button></a>
